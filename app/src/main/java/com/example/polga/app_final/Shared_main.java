...
public class Shared_main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bVolver.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(Shared_main.this, MainActivity.class);
    ...
    public void clickIgual(View v) {
        ...
        Intent intent = new Intent(Shared_main.this,Shared_Resultat.class);
        Bundle b = new Bundle();
